...
S1 <- spwb(x1, fb_meteo, latitude = fb_latitude, elevation = fb_elevation)
# shinyplot(S1)
...
control$sapFluidityVariation <- FALSE
# control$rootDisconnection <- TRUE
...
S2 <- spwb(x2, fb_meteo, latitude = fb_latitude, elevation = fb_elevation)
# shinyplot(S2)