...
results_sureau <- read.table(file="../Tables/results_sureau_KOPT2.txt", sep="\t", header = TRUE)
results_sperry <- read.table(file="../Tables/results_sperry_KOPT2.txt", sep="\t", header = TRUE)
results_sperry_segmented <- read.table(file="../Tables/results_sperry_segmented_KOPT2.txt", sep="\t", header = TRUE)
